...
<html>
	<head>
		<title>Amultiaire y Refrigeracion</title>
		<meta charset="utf-8" />
			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Logo -->
						...
						<h1><a href="index.html" id="logo">Amultiaire Y <em>Refrigeración Enviado</em></a></h1>
...
<!-- 								<li>
			...
			<!-- Banner -->
				<section id="banner">
					<header>
						<h2>No lo piense más, <em> Compre su Aire Acondicionado </em></h2>
						...
						<div class="row">
							...
							<section class="col-6 col-12-narrower">
								<div class="box post">
									...
									<div class="inner">
										<h3>Visión</h3>
										<p align="justify">En el año 2023 AMULTIAIRE Y REFRIGERACIÓN SAS. Contará con la más alta tecnología para la prestación de sus servicios y participara en el mercado de comercialización de repuestos para los sistemas de aires acondicionados y refrigeración importado y nacional. Ser una empresa líder en el suministro de equipos de aire acondicionado así como también en el diseño y ejecución de las instalaciones de los mismos. Satisfacer las necesidades de nuestros clientes tanto particular como empresas o industrias.</p>
									</div>
								</div>
							</section>
						</div>
			...
			<!-- Footer -->
				<div id="footer">
					<div class="container">
						<div class="row">
							...
							<section class="col-6 col-12-narrower">
								...
								<?php 
								$myemail = 'bladimir-0293@hotmail.com';
								$name = $_POST['name'];
								$email = $_POST['email'];
					...
					<!-- Copyright -->
						<div class="copyright">
							<ul class="menu">
								<li>&copy; Todos los derechos reservados AmultiAireyRefrigeracion 2022.</li><li>Design: ITBPCORP</li>
							</ul>
						</div>
